...
(function($ , undefined) {
	...
	function AceAjax(contentArea, settings) {
		...
		this.startLoading = function() {
            ...
            $overlay = $('<div class="ajax-loading-overlay center"><img class="imgLoding" src="' + baseApplicationURL + '/Images/slack_loading.gif" width="30px" style="margin-top: 20px;" /> ' + this.settings.loading_text + '</div>')
	...
	$.fn.aceAjax.defaults = $.fn.ace_ajax.defaults = {
		content_url: false,
		default_url: false,
		loading_icon: 'fa fa-spin fa-spinner fa-2x white',
		loading_text: '',
